...
def player_turn(hands, deck, score, grand_score)
  loop do
  ...
  display_player_stay unless busted?(score[:player])
end

def dealer_turn(hands, deck, score, grand_score)
  loop do
...
loop do
  ...
  loop do
    ...
    player_turn(hands, deck, score, grand_score)
    dealer_turn(hands, deck, score, grand_score) unless busted?(score[:player])
